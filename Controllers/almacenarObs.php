<?php
    ...
    if ($conDB->connect_error) {
        ...
        if (isset($_POST['data'])) {
            ...
            //consulta
            $insertObsSQL = "INSERT INTO `observaciones`(`nombreObservacion`, `created_by`, `created_at`, `observe_startdate`, `integration_totalTime`, `observed_object`, `telescopeUsed`, `filters`, `progress`) VALUES ('$nombreOBS','$created_by','$created_at','$observe_startdate','$integrationTime','$observedObject','$telescopeUsed','$filters','$progress')";
